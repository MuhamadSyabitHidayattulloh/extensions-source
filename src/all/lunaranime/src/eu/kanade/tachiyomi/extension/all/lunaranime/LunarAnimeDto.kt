...
class LunarChapterDto(
    ...
    fun toSChapter(mangaSlug: String, isLocked: Boolean): SChapter = SChapter.create().apply {
        ...
        val chapterName = chapterTitle?.takeIf { it.isNotBlank() } ?: "Chapter $chapter"
...
class LunarPasswordInfoResponse(
    ...
    @SerialName("series_description") val seriesDescription: String? = null,
)
...
class LunarChapterPasswordDto(
    ...
    @SerialName("lock_description") val lockDescription: String? = null,
)

@Serializable
class LunarChapterErrorResponse(
    val error: String? = null,
    @SerialName("is_password_protected") val isPasswordProtected: Boolean = false,
    @SerialName("lock_description") val lockDescription: String? = null,
