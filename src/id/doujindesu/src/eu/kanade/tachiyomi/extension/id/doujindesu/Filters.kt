...
class Category(val display: String, val key: String) {
...
class Order(val display: String, val key: String) {
    override fun toString(): String = display
}

class Status(val display: String, val key: String) {
    override fun toString(): String = display
}
...
class CategoryNames(categories: Array<Category>) : Filter.Select<Category>("Tipe", categories, 0)
